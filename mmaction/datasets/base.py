...
from ..core import (mean_average_precision, mean_class_accuracy,
                    mmit_mean_average_precision, top_k_accuracy, f1_score)
...
class BaseDataset(Dataset, metaclass=ABCMeta):
    ...
    def get_cat_ids(self, idx):
        ...
        return self.video_infos[idx]['label'].astype(np.int) #.tolist()
    ...
    def evaluate(self,
        ...
        allowed_metrics = [
            ...
            'mmit_mean_average_precision', 'f1_score'
        ]
        ...
        gt_labels = [ann['label'] if type(ann['label']) == int else ann['label'][0] for ann in self.video_infos]
